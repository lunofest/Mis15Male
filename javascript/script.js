...
function updateTimer() {
  const targetDate = new Date("february 22, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '542612192009'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542615389920'; // Número para el primer botón
  const recipientNumber2 = '542612192009'; // Número para el segundo botón
